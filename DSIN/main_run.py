...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='cme_eu_oc', help='concatenate(cc) or cross-modality encoder(cme)')
    ...
    parser.add_argument('--context', default=False, help='incorporate context or not', dest='context', type=lambda x: bool(strtobool(x)))
