...
from utils.ch_model import mme
import random
import numpy as np
    ...
    def do_test(self, model, data_loader, mode):    
        ...
        with torch.no_grad():
            for batch in tqdm(data_loader):                    # Loop over all batches.
                ...
                outputs = model(text_inputs, text_mask, audio_inputs, audio_mask, vision_inputs, vision_mask)  # Predictions from 1 batch of data.
